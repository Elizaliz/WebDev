...
<html>
    <head>
        ...
        <script language="javascript" type="text/javascript" src="datetimepicker1.js">
    ...
    <body>
        <h1>Plan a hiking trip!</h1>

        <br />

        <form action="http://localhost:8080/SkerrittModule10/Controller" method=GET>
...
<!--            Duration (days):  <input type="number" name="duration"> -->
            Duration (days):  <select name="duration">
